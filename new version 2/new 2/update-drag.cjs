...
// Add handlers to SVG and selection box rect
code = code.replace(
  /<svg className="absolute inset-0 w-full h-full pointer-events-auto" viewBox="0 0 1000 1000" preserveAspectRatio="xMidYMid meet">/,
  `<svg 
    ref={svgRef}
