  ...
  return (
    <header className="bizos-header">
      <div className="bizos-header-left">
        <button
          className="bizos-header-menu-toggle"
        ...
        <div className="bizos-header-titles">
            ...
            <nav className="bizos-breadcrumb">
              {breadcrumb.map((item, i) => (
                <React.Fragment key={i}>
                  ...
                  {item.href ? (
                    <a href={item.href} className="bizos-breadcrumb-link">
                      {item.label}
                    </a>
                  ) : (
                    <span className="bizos-breadcrumb-current">
                      {item.label}
                    </span>
                  )}
                </React.Fragment>
          ...
          {pageTitle && (
            <div className="bizos-page-title-wrapper">
              ...
              {pageSubtitle && (
                <p className="bizos-page-subtitle">{pageSubtitle}</p>
              )}
            </div>
          )}
        </div>
      ...
      <div className="bizos-header-right">
        ...
        {showNotifications && (
          <button
            className="bizos-header-icon-btn"
        ...
        {showProfile && (
          <button
            className="bizos-header-profile"
